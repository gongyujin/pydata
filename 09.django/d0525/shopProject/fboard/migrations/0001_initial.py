    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('f_createdate', models.DateTimeField(blank=True, default=datetime.datetime(2022, 5, 25, 10, 26, 4, 29911))),
                ('f_updatedate', models.DateTimeField(blank=True, default=datetime.datetime(2022, 5, 25, 10, 26, 4, 29911))),
